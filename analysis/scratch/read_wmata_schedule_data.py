...
import pandas as pd, os, inflection
...
pattern_q_jump_route_dat = pattern_q_jump_route_dat.drop(columns='route_param_set_id')
...
no_nan_pattern_pattern_detail_stop_q_jump_route_dat.rename(
    columns={'stop_sort_order':'stop_sequence',''}
)
