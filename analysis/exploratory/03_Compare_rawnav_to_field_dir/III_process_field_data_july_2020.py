...
path_field_dir = r'C:\Users\abibeka\OneDrive - Kittelson & Associates, Inc\Documents\WMATA-AVL\Data' \
                 r'\field_rawnav_dat'
path_field_file = os.path.join(path_field_dir, 'WMATA AVL field obsv spreadsheet v.2-axb.xlsx')
...
rawnav_tt_decomp = pd.read_csv(os.path.join(path_stop_rawnav,'traveltime_decomp.csv'),index_col=0)

analysis_routes = ['S1', 'S2', 'S4', 'S9', '70', '79', '64', 'G8', 'D32', 'H1', 'H2', 'H3', 'H4','H8','W47']
...
field_rawnav_combine = (pd.concat([field_rawnav_qjump_16_U, field_qjump_irving_16th])
