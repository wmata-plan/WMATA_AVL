...
for analysis_route in analysis_routes:
    ...
    for analysis_day in analysis_days:
        print(
            f'Processing analysis route {analysis_route} for {analysis_day}...')
        ...
        try:
            ...
            print(
                f'No data on analysis route {analysis_route} for {analysis_day}')
            continue
        else:
            ...
            xwalk_seg_pattern_subset = xwalk_seg_pattern.query(
            ...
            for seg in xwalk_seg_pattern_subset.seg_name_id.unique():
                ...
                index_run_segment_start_end, summary_run_segment = (
                    wr.merge_rawnav_segment(
                        ...
                        patterns_by_seg_=xwalk_seg_pattern_subset.loc[
                            xwalk_seg_pattern_subset.seg_name_id == seg]
                    )
                )
