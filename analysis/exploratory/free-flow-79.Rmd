...
rawnav_inventory_filtered_79_ourdata %>%
 count(tag_starthour, wday)
  ...
  ggplot(df, aes(tag_starthour, wday)) + # x and y axes => Var1 and Var2
  geom_tile(aes(fill = n)) + # background colours are mapped according to the value column
  geom_text(aes(fill = n, label = round(df$n, 2))) 
```
...
rawnav_inventory_filtered_79 %>%
 count(tag_starthour, wday)
  ...
  ggplot(df2, aes(tag_starthour, wday)) + # x and y axes => Var1 and Var2
  geom_tile(aes(fill = n)) + # background colours are mapped according to the value column
  geom_text(aes(fill = n, label = round(n, 2))) 
```
